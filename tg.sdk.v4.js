  ...
  win.OpenADTGJsSDK = {
    ...
    interactive: {
      ...
      getRender: function(data){
        ...
        let dynamicHtml = this.hasInterrupt ?
          ...
          `<div class="right close" onclick="window.OpenADTGJsSDK.interactive.cbClose({ zoneId: ${zoneId}, publisherId: ${publisherId} })">`;
        dom.innerHTML = '';
        dom.innerHTML +=
            ...
            `<div class="InteractiveAdContent" onclick="window.OpenADTGJsSDK.interactive.cbLog('click', { 'zoneId':${zoneId}, 'publisherId':${publisherId} })">`+
                '<div class="photo">'+
          ...
          dom.innerHTML +=
              `<div class="InteractiveInterrupt">
                ...
                <div class="action Flex">
                  <i class="Flex" onclick="window.OpenADTGJsSDK.interactive.cbClose({ 'zoneId':${zoneId}, 'publisherId':${publisherId} })">
      ...
      cbClose: function (adInfo){
        let cb = win.OpenADTGJsSDK.resources[`${adInfo.publisherId}_${adInfo.zoneId}`].cb || {}, type = 'close';
        cb.onAdTaskFinished && cb.onAdTaskFinished(false);
        cb.onAdClosing && cb.onAdClosing(true);
        this.destroy(adInfo, cb, type);
      },
    ...
    advertiser: {
      cb: async function(){
        ...
        let url = win.location.href, t = 0, params = {};if(url.includes('?tgWebAppStartParam')){
